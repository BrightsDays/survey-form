...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var count = 0;
  var surveyValue = 0;
  var surveyForm = document.querySelector('.survey__form');
  var surveyItem = document.querySelectorAll('.survey__item');
  var surveyCount = document.querySelector('.survey__counter');
  var surveyImage = document.querySelector('.survey__image');
  var surveyInputs = document.querySelectorAll('.survey__input');
  var surveyButton = document.querySelector('.survey__button');
  var surveyQuestions = document.querySelectorAll('.survey__question');
  ...
  var survey = function survey() {
    if (count < 5) {
      ...
      surveyCount.textContent = "".concat(count + 1, "/6");
      surveyImage.style.background = "linear-gradient(180deg, #111111 9.69%, rgba(17, 17, 17, 0) 49.22%), url(https://viposidn.com/content/MoqeWGih6igQuz1/img/sur_".concat(count + 1, ".jpg)");
      surveyImage.style.backgroundSize = "100% 100%";
    } else {
      surveyButton.style.display = 'none';
      surveyInputs.forEach(function (item) {
        item.style.display = 'none';
      });
  ...
  var scrollToForm = function scrollToForm(buttons, target) {
    var anchors = document.querySelectorAll(buttons);
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        anchor.addEventListener('click', function (e) {
          e.preventDefault();
          var blockID = document.querySelector(target);
